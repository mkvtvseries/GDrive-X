...
<script type="text/javascript">jwplayer.key = "LE4W8HMjWAy7XF5jF/VyO2suBMZe/+tUcxGr+6K4k5zMeEKGgGyZqv2724PFqcuI";</script>
<div id="ancok-player"></div>';
$data = 'var playerInstance = jwplayer("ancok-player");playerInstance.setup({playlist: [{sources:'.$file.'}],preload:"auto",primary:"html5",autostart:"false",playbackRateControls: [0.25, 0.5, 0.75, 1, 2, 3, 4],image:"'.$poster.'",width:"100%",height:"100%",tracks:[{file:"'.$sub.'",label:"English",kind:"captions"}],captions:{color:"#FFFF00",fontSize:15,edgeStyle:"uniform",backgroundOpacity:0,},aboutlink:"https://github.com/karankankaria/GDrive-X",abouttext:"Download GDrive-X Player",sharing: {},advertising:{client:"vast",admessage:"This is an ad pod. This ad ends in xx seconds.",schedule:{adbreak1:{offset:"pre",tag:""},overlay:{offset:"5",tag: "overlay.xml",type:"nonlinear"},adbreak2:{ offset:"50%",tag:""},overlay:{offset:"5", tag:"overlay.xml",type:"nonlinear"}}}});
playerInstance.addButton(
            "http://embed.is-best.net/icon-download.png",
            "Download video", 
            function() {
     		window.open(playerInstance.getPlaylistItem()["link1"]+"?type=video/mp4&title=video_download", "_blank").blur();
